      ...
      <Container>
        <Box className="relative overflow-hidden">
          {brand?.image ? (
            ...
            <Box className="w-full h-[400px] xl:h-[500px]" />
          )}
          ...
          >
            ...
            <Typography
              className={clsx("w-4/5 mt-2 mb-8", "leading-tight", "text-white")}
            >
              {brand?.description}
            </Typography>

            <Box className={clsx("inline-flex flex-wrap gap-2 items-center")}>
              <Badge
                variant="secondary"
                className={clsx(
                  "py-1.5 sm:pt-2 px-4",
